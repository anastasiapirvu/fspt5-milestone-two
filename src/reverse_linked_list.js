...
This method should revers e the linkedList
...
class LinkedList {
  ...
  reverseList() {
    ...
    // Create a variable 'node' to store the reference to this.head.
    //This var will keep track of the "current" node as we advance on the list
